...
DivNoNan::DivNoNan(const ::tensorflow::Scope& scope, ::tensorflow::Input x,
                   ::tensorflow::Input y) {
  if (!scope.ok()) return;
  auto _x = ::tensorflow::ops::AsNodeOut(scope, x);
  if (!scope.ok()) return;
...
Xdivy::Xdivy(const ::tensorflow::Scope& scope, ::tensorflow::Input x,
             ::tensorflow::Input y) {
  if (!scope.ok()) return;
  auto _x = ::tensorflow::ops::AsNodeOut(scope, x);
  if (!scope.ok()) return;
...
Xlogy::Xlogy(const ::tensorflow::Scope& scope, ::tensorflow::Input x,
             ::tensorflow::Input y) {
  if (!scope.ok()) return;
  auto _x = ::tensorflow::ops::AsNodeOut(scope, x);
  if (!scope.ok()) return;
